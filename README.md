...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-comparison/GroupDocs.Comparison-for-Java-Dropwizard/releases/download/1.8.1/release.tar.gz
tar -xvzf release.tar.gz
cd release
java -jar comparison-spring-1.8.1.jar configuration.yaml
## Open http://localhost:8080/comparison/ in your favorite browser.
```
